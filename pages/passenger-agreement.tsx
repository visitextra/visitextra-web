...
import { passengerAgreementData } from "./passenger-agreement.data";

const PassengerAgreementPage = () => {
  const { language } = useLanguage();
  const activeLang = (language === "en" || language === "tr" || language === "ar" ? language : "tr") as "tr" | "en" | "ar";
  const data = passengerAgreementData[activeLang];
...
export default PassengerAgreementPage;
