...
import { kvkkClarificationData } from "./kvkk-clarification.data";

const KvkkClarificationPage = () => {
  const { language } = useLanguage();
  const activeLang = (language === "en" || language === "tr" || language === "ar" ? language : "tr") as "tr" | "en" | "ar";
  const data = kvkkClarificationData[activeLang];
...
export default KvkkClarificationPage;
